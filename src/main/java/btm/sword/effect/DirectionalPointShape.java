...
//
//public class DirectionalPointShape extends EffectShape {
//	Vector positionOffset;
//
//	public DirectionalPointShape(List<ParticleData> particles, int count, double offset, Vector positionOffset) {
