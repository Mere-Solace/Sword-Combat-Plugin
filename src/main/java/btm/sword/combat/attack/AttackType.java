...
//
//	AttackType(double damage, List<EffectHitbox> effectHitboxes, List<EffectShape> effectShapes, double range, double cooldown) {
//		this.damage = damage;
...
//	}
//
//	public List<EffectShape> getVisualEffects() {
//		return effectShapes;
//	}
//
...
//		for (EffectShape visual : effectShapes) {
//			visual.display(origin, direction, range, targets);
//		}
//	}
//}
