...
public final class KeyRegistry {
     ...
     * Value is the {@link btm.sword.item.core.StorageCategory} name string.
     */
     ...
     * {@link btm.sword.item.material.MaterialType} world item.
     * Value is the {@link btm.sword.item.material.MaterialType#id()} string.
     */
    ...
    /** Persistent data key identifying a {@link btm.sword.item.weapon.WeaponType} by its id string. */
     ...
     * Value is the {@link btm.sword.action.skill.SkillId#asString()} of the ability it represents.
     * Used by {@link btm.sword.item.core.AbilityItemReader} to identify and match ability items.
     */
     ...
     * Used by {@link btm.sword.item.special.AbilitySlotItem#isSatisfied} to
