 ...
 * the controller stops (including on SHIFT exit via {@link btm.sword.system.scene.animation.CutsceneInputHandler}).
 * </p>
 *
 ...
 *
 * <h2>Pipeline — exit</h2>
 * Triggered by SHIFT (via {@link btm.sword.system.scene.animation.CutsceneInputHandler}) or by
