 ...
 *
 * <p>Abilities are selected at the start of {@link btm.sword.entity.ai.state.PreAttackState}
 * and executed at the start of {@link btm.sword.entity.ai.state.AttackState} — immediately
...
public interface MobAbility {
     ...
     * Called at the start of {@link btm.sword.entity.ai.state.AttackState}.
     *
