...
/**
 * Represents the combat-related statistical profile for a {@link btm.sword.entity.base.SwordEntity}.
 * <p>
 ...
 *
 * <h2>Usage</h2>
 * A {@code CombatProfile} is created and owned by each {@link btm.sword.entity.base.SwordEntity},
 * where it is used through {@link btm.sword.entity.base.EntityAspects} to drive resource updates
 * and regeneration over time.
 * </p>
 *
 * <h3>Examples of Use:</h3>
 * <ul>
 *   <li>{@link btm.sword.entity.base.SwordEntity#resetResources()} resets stats via this profile.</li>
 *   <li>{@link btm.sword.entity.base.Combatant} references its {@code CombatProfile} to determine
 *       resource thresholds for mechanics such as dashing, blocking, and casting.</li>
 *   <li>{@link btm.sword.combat.affliction.Affliction} subclasses may query stats such as
...
public class CombatProfile {
     ...
     * adjusted in-game through {@link btm.sword.entity.base.EntityAspects}.
     * </p>
     */
     ...
     * before landing. Reset in {@link btm.sword.entity.base.Combatant#resetAirDashesPerformed()}.
     */
    @lombok.Setter
     ...
     *
     * @see btm.sword.entity.base.Combatant#resetAirDashesPerformed()
     */
